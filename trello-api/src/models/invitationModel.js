...
// Query tổng hợp (aggregate) lấy những bản ghi invitation thuộc về 1 user cụ thể
const findByUser = async (userId) => {
  try {
    const queryConditions = [
      { inviteeId: new ObjectId(userId) }, // Tìm theo người đc mời - người đang thực hiện request
      { _destroy: false }
    ]
