...
// Hiểu đơn giản là thay vì phải tạo biến State để chuyển đổi qua lại giữa thẻ Input và Text
// thông thường thì chúng ta sẽ CSS lại cho cái thẻ Input trông như text bình thường, chỉ khi
// click và focus vào nó thì style lại trở về như cái input ban đầu.
...
function ToggleFocusInput({ value, onChangedValue, inputFontSize = '16px', ...props }) {
  ...
  const triggerBlur = () => {
    ...
    // Nếu giá trị không có gì thay đổi hoặc Nếu user xóa hết nội dung thì set lại giá trị gốc ban đầu
    // theo value từ props và return luôn không làm gì thêm
